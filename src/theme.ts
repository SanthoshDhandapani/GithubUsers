      ...
      MuiTableCell: {
        styleOverrides: {
          root: ({ theme }) => ({
            ...
            ...(theme.palette.mode === "dark" && {
              borderColor: `${alpha(gray[200], 0.4)}`,
            }),
          }),
        },
      },
...
export const getCardStyle = (isLightMode: boolean) => ({
  ...
  gap: 4,
  border: isLightMode ? "0px solid" : "1px solid",
  borderColor: isLightMode ? gray[500] : "primary.main",
  backgroundSize: "cover",
  borderRadius: "20px",
  outline: "1px solid",
  outlineColor: isLightMode ? alpha("#dce9f6", 0.5) : alpha(brand[200], 0.1),
  backgroundColor: isLightMode
    ? `linear-gradient(180deg, ${brand[50]}, #FFF)`
